...
<header class="container-fluid  text-white py-2 px-3" style="background-color: #1C3A5B;">
    ...
    <div class="container text-center w-75" style=" background-color: white; padding: 3% 0% 5% 0%; margin-bottom:5%; margin-top:5%;"> 
        ...
        <div class="container w-75 mt-5">
            ...
            <form action="../../src/indigency_form.php" method="POST" id="indigencyForm">
            ...
            <div class="container " style="text-align: left;">
                    ...
                    <div class="h4 mt-5 text-center" style="font-weight: 700;">Indigency</div>
                        ...
                        <div class="col">
                            <div class="form-group mt-4" style="font-weight: 800;" id="type">
                                ...
                                <input type="text"  hidden name="documentType" value="Indigency" required>
                              </div>
                        </div>
                ...
                <div class="d-flex mt-5">
                  ...
                  <div class="ms-auto d-flex w-25" >
                      <button type="button" id="view_form" class="button mt-2 me-2" onclick="validateAndShowConfirmation()">View Form</button>

                      <button type="button" id="next_button" class="button mt-2" onclick="validateAndShowConfirmation()">Finish</button>
                  </div>
              </div>
          ...
          <div class="modal-content" style="width: 150%;">
            ...
            <div class="modal-footer">
               <div class="text-center mx-auto">
                    <button type="submit" class="learn"  style="padding: 5px 15px;" name="submitBtn">Okay</button>
                    </form>
               </div>
...
function validateAndShowConfirmation() {
    if (validateInput()) {
        ...
        // If "View Form" button was clicked
        if (document.activeElement && document.activeElement.id === "view_form") {
            form.setAttribute("target", "_blank"); // Open in new tab
            form.submit();
        } else {
            form.removeAttribute("target"); // Default behavior
            $('#confirmation').modal('show'); // Show confirmation modal
        }
    }
}
