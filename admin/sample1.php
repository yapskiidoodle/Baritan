...
function sendEmail($category, $message, $target_audience, $recipient_email, $recipient_name, $recipient_sex) {
    ...
    $mail = new PHPMailer(true);
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $sql = "INSERT INTO announcement_tbl (announcement_id, category, message, target_audience, delivery_channels, start_date, end_date, image_path, created_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, NOW())";
